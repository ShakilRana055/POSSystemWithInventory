...
(function (factory) {
    ...
    var Plugin = Formstone.Plugin("upload", {
        ...
        defaults: {
            ...
            dataType: "html",
            headers: {},
            label: "Drag and drop file or click to select",
...
function onQueued(e, files) {
    ...
    for (var i = 0; i < files.length; i++) {
        ...
        $.ajax({
            type: 'post',
            url: '/hr/employee/VerifyImportFile',
            data: formData,
            dataType: 'json',
            contentType: false,
            processData: false,
...
function onComplete(e) {
   // toastr.info("Successfully Uploaded! ", "Info");
...
function onFileComplete(e, file, response) {
    ...
    toastr.info("Successfully insert " + result.successfull + " out of " + result.totalrecords, "Info");
